...
void MyChild::newFile()
{
    ...
    isUntitled = true;
    curFile = tr("File %1").arg(sequenceNumber++);
...
bool MyChild::maybeSave()
{
    ...
    ret = QMessageBox::warning(this, tr("Myself Qt Word"),tr("File'%1'has been modified,do you want to save?").arg(userFriendlyCurrentFile()),QMessageBox::Save | QMessageBox::Discard | QMessageBox::Cancel);
